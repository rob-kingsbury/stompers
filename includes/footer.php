<?php
// Ensure tour dates are loaded for the "Next Show" zone
if (!isset($future_shows)) {
  require_once __DIR__ . '/tour-dates.php';
}
$next_show = $future_shows[0] ?? null;

// Month abbreviation to full name
$month_names = [
...
?>
  ...
  <footer class="site-footer-new">
    ...
    <div class="footer-next-show-zone">
      <?php if (!empty($next_show['lat']) && !empty($next_show['lng'])): ?>
      <iframe
    ...
    <div class="footer-utility">
      <div class="footer-strip">
        ...
        <div class="footer-strip-left">
          <a href="contact" class="footer-booking-email">info@swampcitystompers.ca</a>
          <div class="footer-brand-socials">
            <a href="https://www.facebook.com/profile.php?id=61576878274856" target="_blank" rel="noopener" class="footer-social-icon" aria-label="Facebook">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.instagram.com/swamp_city_stompers" target="_blank" rel="noopener" class="footer-social-icon" aria-label="Instagram">
            ...
            <a href="https://youtube.com/playlist?list=PLy1-_1Va1knJ8knIMNVISzCq9HsexLwf-" target="_blank" rel="noopener" class="footer-social-icon" aria-label="YouTube">
      ...
      <div class="footer-bottom">
        <span>&copy; <?= date('Y') ?> Swamp City Stompers &middot; Eastern Ontario, Canada. Site by <a href="https://kingsburycreative.com">Kingsbury Creative</a></span>
